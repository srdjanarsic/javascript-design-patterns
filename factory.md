...
Factory method decouple object instantiation from the client.
It makes codebase more flexible because adding a new object instantiation to factory does not affect either client nor classes used in factory.
